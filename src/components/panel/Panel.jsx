...
const Panel = () => {
  ...
  const { theme, toggleTheme } = useContext(ThemeContext); // HELPERS
  ...
  return (
    <section className="panel">
      ...
      <div className="panel-option">
        ...
        <h2 className="panel-title">35% off</h2>
      </div>
      <div className="panel-option">
        {/* ICON FAVOURITES */}
        <button className="panel-btn">
      ...
      <div className="panel-option">
        ...
        <h2 className="panel-title">faq's</h2>
      </div>
      <div onClick={toggleTheme} className="panel-option">
        {/* ICON DARK MODE */}
        <button className="panel-btn">
          <Theme theme={theme} />
        </button>
        <h2 className="panel-title">{theme === 'light' ? 'dark mode' : 'light mode'}</h2>
      </div>
      <div className="panel-option">
        {/* ICON SETTINGS */}
        <button className="panel-btn">
      ...
      <div onClick={handleSignOut} className="panel-option panel-signout">
        {/* ICON SING OUT */}
        <button className="panel-btn">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
