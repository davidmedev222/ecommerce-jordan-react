...
const EmptyCart = () => {
    ...
    return (
        <>
            {/* TITLE */}
            <h1 className="h1">empty cart</h1>
            {/* ICON */}
            <svg className="empty-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
            ...
            {/* COMPONENT BUTTON */}
            <Button onClick={() => navigate("/shop")} className="empty-btn">
                go to shop
            </Button>
        </>
    );
